...
<head>
    ...
    <script type="text/javascript">
        function changlimit() {
            ...
            location.href = "${path}/station/stationorders?page=1&limit=" + limit;
        }
    </script>
</head>
<body>
        ...
        <c:otherwise>
            ...
            <ul class="pager">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li><a href="${path}/station/stationorders?page=${page.firstPage}&limit=${limit}">首页</a></li>
                        <li><a href="${path}/station/stationorders?page=${page.prePage}&limit=${limit}">&laquo;上一页</a>
                        </li>
                    </c:otherwise>
                </c:choose>
                <c:choose>
                    ...
                    <c:otherwise>
                        <li><a href="${path}/station/stationorders?page=${page.nextPage}&limit=${limit}">下一页&raquo;</a>
                        </li>
                        <li><a href="${path}/station/stationorders?page=${page.lastPage}&limit=${limit}">最后页</a></li>
                    </c:otherwise>
                </c:choose>
