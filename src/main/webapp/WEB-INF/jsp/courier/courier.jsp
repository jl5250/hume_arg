...
<body>
<iframe src="${path }/courier/welcomecourier" name="iframe_top" height="80px;" width="100%" frameborder="0"></iframe>
<div>
    <iframe src="${path }/courier/couriermenu" name="iframe_left" id="iframe_left" frameborder="0" width="10%"
            height="856px"></iframe>
    <iframe src="${path }/courier/showpage" name="iframe_right" id="iframe_right" frameborder="0"
            style="overflow: hidden;" width="85%" height="856px"></iframe>
</div>
</body>
</html>