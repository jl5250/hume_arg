...
<head>
    ...
    <script type="text/javascript">
        function changlimit() {
            ...
            location.href = "${path}/courier/receiveorder?page=1&limit=" + limit;
        }
    </script>
</head>
<body>
        ...
        <c:otherwise>
            <table class="table table-hover">
                ...
                <c:forEach begin="0" step="1" items="${userlist}" var="list" varStatus="userlist">
                    ...
                    <tr>
                        ...
                        <td><a href="${path }/courier/receiveorder?orderId=${list.orderId}">接收</a></td>
                    </tr>
                    </tbody>
                </c:forEach>
            </table>
            <ul class="pager">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li><a href="${path}/courier/receiveorder?page=${page.firstPage}&limit=${limit}">首页</a></li>
                        <li><a href="${path}/courier/receiveorders?page=${page.prePage}&limit=${limit}">&laquo;上一页</a>
                        </li>
                    </c:otherwise>
                </c:choose>
                <c:choose>
                    ...
                    <c:otherwise>
                        <li><a href="${path}/courier/receiveorder?page=${page.nextPage}&limit=${limit}">下一页&raquo;</a>
                        </li>
                        <li><a href="${path}/courier/receiveorder?page=${page.lastPage}&limit=${limit}">最后页</a></li>
                    </c:otherwise>
                </c:choose>
