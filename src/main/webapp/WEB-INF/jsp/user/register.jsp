...
<script type="text/javascript">
	...
	function checkEmail() {
		...
		if (/^(\w-*\.*)+@(\w-?)+(\.\w{2,})+$/.test(email)) {
			document.getElementById("checkEmail").innerHTML="输入正确";
			return true;
		}else{
	...
	function checkAll() {
		...
		var email1 = document.getElementById("register_email").value;
		var addr = document.getElementById("register_addr").value;
		if(account==""||password==""||confirm==""||userName==""||realName==""||phone1==""||email1==""||addr==""){
			alert("请完整填写您的信息");
			return false;
		}else {
			return true;
	...
	function check() {
		if(checkAll()&&checkPassword()&&checkPhone()&&checkEmail()){
			return true;
		}else{
			alert("请核对您填写的信息");
			return false;
...
<body>
	...
	<h1 class="text-center">欢迎注册顶铮会员</h1>
	<div class="container" align="center">
		<form action="${path }/register/userregister" method="post" class="form-horizontal"
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input class="form-control" type="text" id="register_user_name"
						name="register_user_name" placeholder="请输入你喜欢的用户名">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input class="form-control" type="text" id="register_email"
						name="register_email" placeholder="请输入您的邮箱"
						onchange="checkEmail()">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input class="form-control" type="text" id="register_addr" name="register_addr" placeholder="请输入您的默认地址">
				</div>
			</div>
			<div class="form-group">
