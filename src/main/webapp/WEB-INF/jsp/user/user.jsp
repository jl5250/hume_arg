...
<body style= "margin:0">
	<iframe src="${path }/user/welcomeuser" name="iframe_top" height="80px;" width="100%" frameborder="0"></iframe>
	<div>
		<iframe src="${path }/user/userMenu" name="iframe_left" id="iframe_left" frameborder="0" width="10%" height="856px"></iframe>
		<iframe src="${path }/user/showPage" name="iframe_right" id="iframe_right" frameborder="0" style="overflow: hidden;" width="89%" height="856px"></iframe>
	</div>
</body>
</html>