...
<head>
    ...
    <script type="text/javascript">
        function changlimit() {
            ...
            location.href = "${path}/root/findallorders?page=1&limit=" + limit;
        }
    </script>
</head>
<body>
        ...
        <c:otherwise>
            ...
            <ul class="pager">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li><a href="${path}/root/findallorders?page=${page.isFirstPage}&limit=${limit}">首页</a></li>
                        <li><a href="${path}/root/findallorders?page=${page.prePage}&limit=${limit}">&laquo;上一页</a></li>
                    </c:otherwise>
                </c:choose>
                <c:choose>
                    <c:when test="${page.pageNum == page.pages }"/>
                    <c:otherwise>
                        <li><a href="${path}/root/findallorders?page=${page.nextPage}&limit=${limit}">下一页&raquo;</a>
                        </li>
                        <li><a href="${path}/root/findallorders?page=${page.isLastPage}&limit=${limit}">最后页</a></li>
                    </c:otherwise>
                </c:choose>
                ...
                <li>条数据
                    ...
                    <a id="tuichu" class="btn btn-info btn-sm" href="<c:url value="/login/login"/>">退出</a>
                </li>
            </ul>
        </c:otherwise>
    </c:choose>
